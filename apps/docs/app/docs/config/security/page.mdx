export const metadata = {
  title: 'Security',
  description:
    'Security-first design in @neststack/config — automatic secret masking in logs, deep-frozen immutable config, Zod validation, and PCI-DSS aligned practices.',
  alternates: { canonical: '/docs/config/security' },
};
