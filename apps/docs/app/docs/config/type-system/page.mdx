export const metadata = {
  title: 'Type System',
  description:
    'Recursive dot-path TypeScript types in @neststack/config give you auto-completion and compile-time safety for every configuration key — no string guessing.',
  alternates: { canonical: '/docs/config/type-system' },
};
