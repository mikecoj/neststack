export const metadata = {
  title: 'Performance',
  description:
    'O(1) configuration lookups via pre-built flat maps, zero-overhead secret masking, and deep-freeze immutability with minimal startup cost.',
  alternates: { canonical: '/docs/config/performance' },
};
