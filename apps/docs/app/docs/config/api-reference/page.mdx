export const metadata = {
  title: 'API Reference',
  description:
    'Complete API reference for @neststack/config — defineConfig(), ConfigService, NestStackConfigModule, ConfigStore, and all exported types.',
  alternates: { canonical: '/docs/config/api-reference' },
};
