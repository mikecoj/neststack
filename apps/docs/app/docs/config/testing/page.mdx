export const metadata = {
  title: 'Testing',
  description:
    'Test NestJS applications with @neststack/config using envSource injection and NestStackConfigModule.reset() to isolate configuration state between tests.',
  alternates: { canonical: '/docs/config/testing' },
};
