export const metadata = {
  ...
  description:
    'Learn how to define type-safe NestJS configuration with Zod schemas, namespace declarations, loaders, and secret key designations using @neststack/config.',
  alternates: { canonical: '/docs/config/defining-config' },
};
