export const metadata = {
  title: 'Packages',
  description:
    'Explore enterprise-grade NestJS packages from NestStack — type-safe, fully tested, and built for banking and fintech applications.',
...
[Get started with @neststack/config &rarr;](/docs/config)
