...
Configuration definitions are the foundation of `@nestx/advanced-config`. Each definition declares a namespace, a Zod schema, an optional loader function, and optional secret keys.
