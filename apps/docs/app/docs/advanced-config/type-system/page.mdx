...
`@nestx/advanced-config` provides recursive TypeScript types for fully-typed dot-notation access. These types give you auto-completion and compile-time safety for every config key.
